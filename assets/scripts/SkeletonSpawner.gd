...
var skeleton_scene = preload("res://assets/scenes/enemy1.tscn")
...
func test_position(position : Vector2):
	...
	#House1,rocky,Big-Tree
	var no_trees = (cell_type_id != tilemap.tile_set.find_tile_by_name("Tree")||tilemap.tile_set.find_tile_by_name("Big-Tree")||tilemap.tile_set.find_tile_by_name("House1")||tilemap.tile_set.find_tile_by_name("rocky"))
